...
// to return -1to indicate an invalid value.
...
public class PaintJobQuestion {
    ...
    private static int getBucketCount(double width, double height, double areaPerBucket, int extraBuckets) {
        ...
        if ((width <= 0) || (height <= 0) || (areaPerBucket <= 0) || (extraBuckets < 0)) {
            ...
            bucketsNeeded = (width * height) / areaPerBucket;
    ...
    public static void main(String[] args) {
        System.out.println("The total number of buckets needed is: " + getBucketCount(0.75, 0.75, 0.5,0));
