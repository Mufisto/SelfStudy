...
// 5 kilos and cannot be divided. However, if goal = 9, bigCount = 1, and smallCount = 5, the method 
// should return true because of 1 full bigCount bag and 4 full smallCount bags equal goal, and it's okay if there are 
// additional bags left over.

// If any of the parameters are negative, return false.

public class FlourPackQuestion {
